  ...
  return (
    <div className="Blog">
      ...
      <p>
        ...
        changable where props is readly only data, means you can't change or
        update it.
      </p>
      ...
      <p>
        ...
        called multiple time ,whenever dom update component is updated , to
      ...
      <p>
        React is a JS library which work creating a virtual Dom in its memoroy
        which detect difference between virtual and original Dom with DIFF
        Algortihm and only change that part of the tree, so it is faster.
      </p>
    </div>
  );
};
